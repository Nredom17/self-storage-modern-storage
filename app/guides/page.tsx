...
export const GUIDES = [
  { href: '/guides/storage-unit-sizes', cluster: 'Storage Unit Sizes', icon: '📦', title: 'Storage Unit Sizes Guide', description: 'Complete walkthrough of every Modern Storage® unit size — 5x5 to 10x30 — with what fits in each, climate-controlled vs drive-up pricing, and how to pick the right size.', readTime: '7 min read', featured: true },
  { href: '/guides/storage-security', cluster: 'Security & Smart Locks', icon: '🔒', title: 'Storage Unit Security Guide', description: 'Gated access, video surveillance, perimeter fencing, disc locks, on-site management — plus a 10-step pre-rent checklist for evaluating any facility.', readTime: '6 min read', featured: false },
  { href: '/guides/apartment-storage', cluster: 'Moving & Residential', icon: '🏠', title: 'Apartment Storage Guide', description: 'Compare 5x5 and 5x10 unit sizes, college-storage strategies, and which Modern Storage® Arkansas locations are closest to apartment complexes.', readTime: '5 min read', featured: true },
  { href: '/guides/moving-storage', cluster: 'Moving & Residential', icon: '🚚', title: 'Storage During a Move', description: 'Storage between leases, military PCS, long-distance relocation, and renovation moves. Pair with the free moving truck for one-trip move-in.', readTime: '5 min read', featured: false },
  { href: '/climate-controlled-arkansas-humidity', cluster: 'Climate-Controlled', icon: '❄️', title: 'Climate-Controlled Storage for Arkansas Humidity', description: 'How Arkansas humidity damages stored belongings — month-by-month humidity table, garage vs. attic vs. climate-controlled comparison, and what belongs indoors.', readTime: '8 min read', featured: true },
  { href: '/business-storage-bentonville', cluster: 'Business Storage', icon: '🏢', title: 'Supplier & Business Storage in Bentonville', description: 'Climate-controlled and business storage for NWA vendors, suppliers, e-commerce sellers, and Bentonville-area small businesses near the Walmart Home Office.', readTime: '6 min read', featured: true },
  { href: '/contractor-storage-little-rock', cluster: 'Business Storage', icon: '🔧', title: 'Contractor Storage in Little Rock', description: 'Tools, jobsite overflow, restoration crew kits, and trade inventory storage at four Little Rock area Modern Storage® locations.', readTime: '5 min read', featured: false },
  { href: '/storage-near-beaver-lake', cluster: 'RV & Boat Storage', icon: '⛵', title: 'Boat & RV Storage Near Beaver Lake', description: 'Off-season boat storage, year-round RV parking, and trailer spaces minutes from Beaver Lake marinas. Lowell location on I-49.', readTime: '5 min read', featured: false },
]
