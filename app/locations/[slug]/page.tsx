          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <div className="flex flex-col gap-3">
                ...
                {/* Second row — audience-split pills with distinct colors.
                    Rent a Unit (red) calls the centralized line. Existing
                    Customers (white) opens the modernstorage.com tenant /
                    self-storage portal. Phone number lives in aria-label
                    only — the pill itself dials when tapped. */}
                <div className="flex flex-wrap gap-3">
                  <a
                    href={`tel:${loc.phone.replace(/[^\d+]/g, '')}`}
                    aria-label={`Rent a Unit — call ${loc.phone}`}
