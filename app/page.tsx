        ...
        <div className="max-w-7xl mx-auto px-6 py-12 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-6 lg:col-start-1 lg:row-start-1">
              ...
              {/* Audience split — Rent a Unit (red) dials the centralized
                  line; Tenant Support (white) opens the
            ...
            <div className="lg:col-span-6 lg:col-start-1 lg:row-start-2">
              ...
              {/* Trust signals — 4 icon-driven items in a 2-col grid on
                  ...
                  lines on mobile. */}
              <ul className="grid grid-cols-2 sm:flex sm:flex-wrap gap-x-6 gap-y-3 text-sm sm:text-base font-semibold text-white">
                {TRUST_SIGNALS.map(({ icon: Icon, text }) => (
                  <li key={text} className="flex items-center gap-2">
                    <Icon className="w-5 h-5 text-modern-red shrink-0" strokeWidth={2} aria-hidden="true" />
                    <span>{text}</span>
                  </li>
                ))}
              </ul>
