...
export const FAQS = [
  ...
  {
    q: 'What are the access hours at Modern Storage®?',
    // Phase 1 entry (Block 7) — REWRITTEN 2026-06-05 per
    // Alexandra's direction: Modern Storage® does NOT offer 24-hour
    // access at any facility. The honest, uniform policy across all
    // 10 Arkansas locations is 7-day gated tenant access from 6:00
    // AM to 10:00 PM. No "extended-hour exceptions", no "select
    // locations support 24-hour", no business-storage 24/7. Every
    // mention of 24-hour or 24/7 access was a fabrication and has
    // been removed from the codebase.
    a: `Modern Storage® offers 7-day gated tenant access from 6:00 AM to 10:00 PM at every Arkansas location. There is no 24-hour access at any Modern Storage® facility. Every tenant gets a personal entry code at move-in that is logged on every entry and exit, so the facility tracks who is on-site. The office at each location is staffed during business hours (typically 8:30 AM to 5:30 PM Monday through Saturday, with Sunday hours varying by location) for new rentals, tours, and in-person tenant questions. Access hours at Modern Storage®: 7-day gated tenant access from 6:00 AM to 10:00 PM at every location; personal entry code per tenant, logged on every entry and exit; no 24-hour access — the gate closes at 10:00 PM every night; office hours (typically Mon-Sat 8:30 AM - 5:30 PM) for new rentals and in-person questions; Sunday office hours vary by location — Maumelle Blvd and Lowell are closed Sundays.`,
    aHtml: `<p>Modern Storage® offers 7-day gated tenant access from <strong>6:00 AM to 10:00 PM</strong> at every Arkansas location. There is <strong>no 24-hour access</strong> at any Modern Storage® facility.</p><p>Every tenant gets a personal entry code at move-in that is logged on every entry and exit, so the facility tracks who is on-site. The office at each location is staffed during business hours (typically 8:30 AM to 5:30 PM Monday through Saturday, with Sunday hours varying by location) for new rentals, tours, and in-person tenant questions.</p><p><strong>Access hours at Modern Storage®:</strong></p><ul><li><strong>7-day gated tenant access from 6:00 AM to 10:00 PM</strong> at every location</li><li>Personal entry code per tenant, logged on every entry and exit</li><li><strong>No 24-hour access</strong> — the gate closes at 10:00 PM every night</li><li>Office hours (typically Mon-Sat 8:30 AM - 5:30 PM) for new rentals and in-person questions</li><li>Sunday office hours vary by location — <a href="/locations/maumelle">Maumelle Blvd</a> and <a href="/locations/lowell">Lowell</a> are closed Sundays</li></ul>`,
  },
  {
