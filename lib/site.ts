...
export const FAQS = [
  ...
  },
  {
    ...
    // Net-new Phase 1 entry (Block 5). Distinct framing from the
    // existing month-to-month Q&A — answers the explicit fear
    // ("am I locked in?") that customers ask before they reserve.
    // Concise→detailed→bullets format per the SEO plan.
    a: `No — Modern Storage® storage rentals are month-to-month with no long-term contract, no annual commitment, and no early-termination fee. You pay one month at a time, and you can move out at the end of any month with written notice. There is no penalty for short stays — many customers rent for 30 to 90 days during a move or renovation, while others keep a unit for years for ongoing household, business, or vehicle storage. What month-to-month means at Modern Storage®: no long-term contract — pay one month at a time; no minimum stay beyond the first month; no annual or multi-year commitment required; no early-termination fee if you move out sooner than expected; written notice required before move-out (typically by the end of the current billing cycle); rent the same unit for one month or several years — your choice.`,
    aHtml: `<p>No — Modern Storage® storage rentals are month-to-month with no long-term contract, no annual commitment, and no early-termination fee. You pay one month at a time, and you can move out at the end of any month with written notice.</p><p>There is no penalty for short stays — many customers rent for 30 to 90 days during a move or renovation, while others keep a unit for years for ongoing household, <a href="/business-storage">business</a>, or <a href="/rv-boat-vehicle">vehicle storage</a>.</p><p><strong>What month-to-month means at Modern Storage®:</strong></p><ul><li>No long-term contract — pay one month at a time</li><li>No minimum stay beyond the first month</li><li>No annual or multi-year commitment required</li><li>No early-termination fee if you move out sooner than expected</li><li>Written notice required before move-out (typically by the end of the current billing cycle)</li><li>Rent the same unit for one month or several years — your choice</li></ul>`,
  },
  {
  ...
  {
    q: 'How secure are Modern Storage® facilities?',
    ...
    //
    // Question reworded from "Are storage units secure?" → "How secure
    // are Modern Storage® facilities?" to target the higher-intent
    // PAA query and match the Section 6 / Block 6 phrasing exactly.
    a: `Yes — Modern Storage® facilities are secured with a combination of gated access with personal entry codes, exterior lighting, perimeter fencing, and video surveillance. Each tenant gets a unique entry code that is logged on every entry and exit, so the facility tracks who's on-site. Customers secure their individual unit with their own disc lock or padlock — a disc lock is recommended because it resists bolt cutters and weather. Specific camera coverage, lighting, and on-site staffing vary by facility, and tenants are required to maintain insurance or tenant protection coverage for stored property. Key security features at Modern Storage® include: a perimeter gate with personal entry codes per tenant; entry/exit activity logged against each tenant account; exterior lighting and perimeter fencing; video surveillance systems on the gate and drive aisles; individually locked unit doors with tenant-supplied disc locks; staff-managed move-in process with ID verification; required tenant insurance or tenant protection coverage at move-in.`,
    aHtml: `<p>Yes — Modern Storage® facilities are secured with a combination of gated access with personal entry codes, exterior lighting, perimeter fencing, and video surveillance.</p><p>Each tenant gets a unique entry code that is logged on every entry and exit, so the facility tracks who's on-site. Customers secure their individual unit with their own disc lock or padlock — a disc lock is recommended because it resists bolt cutters and weather. Specific camera coverage, lighting, and on-site staffing vary by facility, and tenants are required to maintain insurance or tenant protection coverage for stored property.</p><p><strong>Security features at Modern Storage®:</strong></p><ul><li>Perimeter gate with personal entry codes — one code per tenant, not a shared keypad</li><li>Entry/exit activity logged against each tenant account</li><li>Exterior lighting and perimeter fencing</li><li>Video surveillance on the gate and drive aisles</li><li>Individually locked unit doors with tenant-supplied disc locks (only you hold the key)</li><li>Staff-managed move-in process with ID verification</li><li>Required tenant insurance or tenant protection coverage at move-in</li></ul><p>For a deeper look at facility security, see the <a href="/guides/storage-security">storage security guide</a>.</p>`,
  },
  {
    q: 'Can I access my storage unit 24 hours a day?',
    // Net-new Phase 1 entry (Block 7). Source: established stance in
    // lib/business-storage.ts ("Extended and 24/7 gated access is
    // available at select Modern Storage® locations") and
    // lib/rv-boat-vehicle.ts ("Most Modern Storage® facilities offer
    // 7-day gated access... some facilities offer extended hours or
    // 24-hour access"). Honest about variation by facility — does not
    // promise 24-hour everywhere.
    a: `Most Modern Storage® locations offer 7-day gated tenant access during extended daily hours, and 24-hour gated access is available at select Arkansas facilities. Specific gate hours vary by location — confirm with your local Modern Storage® team before reserving if early-morning or late-night access matters for your situation (lake mornings, business deliveries, contractor pickups). Every tenant gets a personal entry code at move-in that is logged on every entry and exit, so the facility tracks who is on-site. About access at Modern Storage®: 7-day gated access at most locations with personal entry codes per tenant; extended daily access hours, with 24-hour access available at select facilities; access hours vary by location — check the location page for your nearest facility; some business storage customers can request expanded access for deliveries and pickups; if 24-hour access is critical to your situation, confirm availability before you reserve.`,
    aHtml: `<p>Most Modern Storage® locations offer 7-day gated tenant access during extended daily hours, and 24-hour gated access is available at select Arkansas facilities. Specific gate hours vary by location — confirm with your local Modern Storage® team before reserving if early-morning or late-night access matters for your situation (lake mornings, business deliveries, contractor pickups).</p><p>Every tenant gets a personal entry code at move-in that is logged on every entry and exit, so the facility tracks who is on-site.</p><p><strong>About access at Modern Storage®:</strong></p><ul><li>7-day gated access at most locations, with personal entry codes per tenant</li><li>Extended daily access hours, with 24-hour access available at select facilities</li><li>Access hours vary by location — check the <a href="/locations">location page</a> for your nearest facility</li><li>Some <a href="/business-storage">business storage</a> customers can request expanded access for deliveries and pickups</li><li>If 24-hour access is critical to your situation, confirm availability before you reserve</li></ul>`,
  },
  {
    q: 'What cannot be stored in a storage unit?',
    a: `Self-storage units cannot be used for living, sleeping, or working out of, and cannot hold hazardous, flammable, perishable, or illegal items. That includes gasoline and fuel, propane tanks, paint and solvents, fireworks, ammunition, food and groceries, plants, live animals, stolen property, and anything regulated by state or federal law. Wet items should also be avoided — they cause mold that can damage neighboring units. Modern Storage® provides a full prohibited-items list at move-in for each Arkansas storage facility. Common prohibited items include: gasoline, diesel, kerosene, and other fuels (drain mowers and equipment before storing); propane and pressurized tanks; paint, solvents, and aerosols; fireworks, ammunition, and explosives; food, groceries, and perishables; plants and live animals; wet, damp, or moldy items; cash, jewelry, and irreplaceable valuables (these belong in a safe-deposit box); stolen property or anything illegal under state or federal law.`,
    aHtml: `<p>Self-storage units cannot be used for living, sleeping, or working out of, and cannot hold hazardous, flammable, perishable, or illegal items. Modern Storage® provides a full prohibited-items list at move-in for each <a href="/locations">Arkansas storage facility</a>.</p><p>Items that cause damage to neighboring units — like wet, damp, or food-bearing items — are also restricted because mold and pests spread through shared walls. The prohibited list exists to protect every tenant's property, not just yours.</p><p><strong>Items you cannot store at Modern Storage®:</strong></p><ul><li>Gasoline, diesel, kerosene, and other fuels (drain mowers, blowers, and equipment before storing)</li><li>Propane and pressurized tanks</li><li>Paint, solvents, and aerosols</li><li>Fireworks, ammunition, and explosives</li><li>Food, groceries, and perishables</li><li>Plants and live animals</li><li>Wet, damp, or moldy items</li><li>Cash, jewelry, and irreplaceable valuables — use a safe-deposit box instead</li><li>Stolen property or anything illegal under state or federal law</li></ul>`,
  },
  {
    q: 'Do I need insurance for items in storage?',
    // Question reworded from "Is storage insurance required?" → "Do I
    // need insurance for items in storage?" to match the higher-intent
    // PAA phrasing (Block 8 in the SEO plan). Bullet summary added at
    // the bottom for AEO extraction.
    a: `Yes — tenants at Modern Storage® are required to maintain insurance or tenant protection coverage for stored items. Many homeowners and renters insurance policies may extend coverage to items stored off-premises, so customers should check with their insurance provider for details and limitations. Proof of qualifying insurance may be required after move-in. If acceptable coverage is not provided, tenants may be automatically enrolled in a tenant protection plan offered at the facility. Coverage options and pricing vary based on the declared value of stored items. Storage coverage may help protect against certain losses such as fire, theft, or water damage, subject to the terms, conditions, and exclusions of the applicable policy or protection plan. About storage insurance at Modern Storage®: insurance or a tenant protection plan is required at move-in — not optional; check your existing homeowners or renters policy first — many extend to off-premises stored items; if you do not have qualifying coverage, the facility offers a tenant protection plan you can enroll in at move-in; plan pricing scales with the declared value of your stored items; coverage helps protect against certain losses (fire, theft, water damage) subject to plan terms; the storage facility itself does not insure your belongings — coverage is on you.`,
    aHtml: `<p>Yes — tenants at Modern Storage® are required to maintain insurance or tenant protection coverage for stored items. Many homeowners and renters insurance policies may extend coverage to items stored off-premises, so customers should check with their insurance provider for details and limitations.</p><p>Proof of qualifying insurance may be required after move-in. If acceptable coverage is not provided, tenants may be automatically enrolled in a tenant protection plan offered at the facility. Coverage options and pricing vary based on the declared value of stored items.</p><p>Storage coverage may help protect against certain losses such as fire, theft, or water damage, subject to the terms, conditions, and exclusions of the applicable policy or protection plan.</p><p><strong>What to know about storage insurance:</strong></p><ul><li>Insurance or a tenant protection plan is required at move-in — not optional</li><li>Check your existing homeowners or renters policy first — many extend to off-premises stored items</li><li>If you do not have qualifying coverage, the facility offers a tenant protection plan you can enroll in at move-in</li><li>Plan pricing scales with the declared value of your stored items</li><li>Coverage helps protect against certain losses (fire, theft, water damage) subject to plan terms</li><li>The storage facility itself does not insure your belongings — coverage is on you</li></ul>`,
  },
  // ── PAA-targeting FAQs ────────────────────────────────────
