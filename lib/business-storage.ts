export const BUSINESS_FEATURES = [
  ...
  {
    title: '7-day gated access',
    // REWRITTEN 2026-06-05 — Modern Storage® does NOT offer 24-hour
    // or "extended" business-storage access. Uniform 6 AM – 10 PM
    // policy across every Arkansas location.
    body:
      'Gated tenant access 7 days a week from 6:00 AM to 10:00 PM at every Modern Storage® Arkansas location. Personal entry code per tenant — every entry and exit is logged against your account.',
    icon: 'clock',
  },
] as const
...
export const BUSINESS_FAQS = [
  {
    ...
    a: `Yes — Modern Storage® offers business storage for inventory, tools, supplies, equipment, records, and commercial overflow. Business storage works well for e-commerce sellers, contractors, restoration crews, real estate professionals, document archive needs, and small businesses that need flexible month-to-month space without a commercial lease. Storage units are intended for storage rather than as active workspaces, repair shops, or operating business locations — though select Modern Storage® facilities accept business deliveries and offer dock-height loading for higher-volume commercial use. Modern Storage® Riverdale is the flagship business storage facility in central Arkansas with loading docks and freight access. All facilities offer 7-day gated access from 6:00 AM to 10:00 PM. Common business uses for a Modern Storage® unit: e-commerce inventory — receive shipments, pick-and-pack, ship out; contractor tools, ladders, materials, and equipment; restoration packouts and emergency-response staging; document archives for law firms, medical, dental, and accounting practices; real estate staging furniture and seasonal display inventory; trade-show booths, signage, and marketing materials between events; office furniture and electronics during a relocation or remodel; moving-company overflow and customer holds when a closing slides.`,
    aHtml: `<p>Yes — Modern Storage® offers <a href="/business-storage">business storage</a> for inventory, tools, supplies, equipment, records, and commercial overflow. Business storage works well for e-commerce sellers, contractors, restoration crews, real estate professionals, document archive needs, and small businesses that need flexible month-to-month space without a commercial lease.</p><p>Storage units are intended for storage rather than as active workspaces, repair shops, or operating business locations — though select Modern Storage® facilities accept business deliveries and offer dock-height loading for higher-volume commercial use. <a href="/locations/riverdale">Modern Storage® Riverdale</a> is the flagship business storage facility in central Arkansas with loading docks and freight access. All facilities offer 7-day gated access from 6:00 AM to 10:00 PM.</p><p><strong>Common business uses for a Modern Storage® unit:</strong></p><ul><li>E-commerce inventory — receive shipments, pick-and-pack, ship out</li><li>Contractor tools, ladders, materials, and equipment</li><li>Restoration packouts and emergency-response staging</li><li>Document archives for law firms, medical, dental, and accounting practices</li><li>Real estate staging furniture and seasonal display inventory</li><li>Trade-show booths, signage, and marketing materials between events</li><li>Office furniture and electronics during a relocation or remodel</li><li>Moving-company overflow and customer holds when a closing slides</li></ul>`,
  },
  {
  ...
  {
    q: 'What are the access hours for business storage?',
    // REWRITTEN 2026-06-05 — Modern Storage® does NOT offer 24/7 or
    // extended-hour business storage access. Uniform 6 AM – 10 PM.
    a: `Modern Storage® offers 7-day gated tenant access from 6:00 AM to 10:00 PM at every Arkansas location, including for business storage customers. There is no 24-hour access at any Modern Storage® facility. Personal entry code per tenant — every entry and exit is logged against your account. If your business operation requires after-hours access, plan deliveries, contractor pickups, and inventory movement within the 6:00 AM to 10:00 PM gate window.`,
  },
  {
