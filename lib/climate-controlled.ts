...
export const CLIMATE_FAQS = [
  {
    // Phase 1 / Block 2 — upgraded to concise→detailed→bullets format.
    // The plain-text `a` is written so the FAQPage JSON-LD schema
    // still reads as one coherent answer; the bulleted detail lives
    // in `aHtml` for the visible accordion.
    q: 'What is climate-controlled storage?',
    a: `Climate-controlled storage means your unit is located inside an enclosed indoor building designed to provide a more stable storage environment than a standard outdoor drive-up unit. These indoor storage units are kept within a managed temperature range — at Modern Storage® approximately 59°F to 79°F — and protect belongings from the worst of Arkansas summer heat, winter cold, and humidity swings. Climate-controlled units are commonly used for furniture, electronics, documents, photos, mattresses, instruments, wine, business inventory, and long-term storage of household items. Availability varies by location. What climate-controlled storage gives you at Modern Storage®: indoor access from interior hallways inside an enclosed, conditioned building; a managed indoor temperature range of roughly 59°F to 79°F year-round; reduced humidity exposure compared to outdoor units, garages, attics, and basements; protection from Arkansas summer humidity (70%+) and 100°F+ heat indexes; protection from winter cold fronts that can swing 40°F in 24 hours; lower dust, pollen, and pest exposure than outdoor drive-up units; gated facility access with personal entry codes and individually locked unit doors.`,
    aHtml: `<p>Climate-controlled storage means your unit is located inside an enclosed indoor building designed to provide a more stable storage environment than a standard outdoor drive-up unit. These indoor storage units are kept within a managed temperature range — at Modern Storage® approximately <strong>59°F to 79°F</strong> — and protect belongings from the worst of Arkansas summer heat, winter cold, and humidity swings.</p><p>Climate-controlled units are commonly used for furniture, electronics, documents, photos, mattresses, instruments, wine, business inventory, and long-term storage of household items. Availability varies by location.</p><p><strong>What climate-controlled storage gives you at Modern Storage®:</strong></p><ul><li>Indoor access from interior hallways inside an enclosed, conditioned building</li><li>A managed indoor temperature range of roughly <strong>59°F to 79°F</strong> year-round</li><li>Reduced humidity exposure compared to outdoor units, garages, attics, and basements</li><li>Protection from Arkansas summer humidity (70%+) and 100°F+ heat indexes</li><li>Protection from winter cold fronts that can swing 40°F in 24 hours</li><li>Lower dust, pollen, and pest exposure than outdoor drive-up units</li><li>Gated facility access with personal entry codes and individually locked unit doors</li></ul>`,
  },
  {
    // Phase 1 — upgraded to concise→detailed→bullets. Direct PAA
    // target. The Arkansas humidity / heat angle is the
    // differentiation a national brand can't write authentically.
    q: 'Is climate-controlled storage worth it in Arkansas?',
    a: `Yes — climate-controlled storage is usually worth it in Arkansas because the weather can shift from 100°F-plus humid summers to sub-freezing winter cold fronts in the same year. Arkansas summer humidity routinely exceeds 70%, heat indexes top 100°F, and home garages can hit 120°F+ in direct sun — well above the safe storage range for furniture, electronics, photos, and instruments. Climate-controlled storage at Modern Storage® gives those items an indoor environment that stays in a stable 59°F to 79°F range year-round. If you'd hesitate to leave it in a hot garage, climate-controlled is the safer choice. Climate-controlled storage is worth it in Arkansas if you are storing any of: wood furniture, leather furniture, or mattresses (warp, crack, and mildew in humid air); electronics, TVs, computers, or media equipment (heat degrades capacitors and screens); family photos, documents, books, or art (paper yellows and curls above ~70% humidity); musical instruments, vinyl records, or wine (warp, mildew, or spoil in heat); items stored for more than three months (cumulative damage builds in unconditioned spaces); business inventory, samples, or records that need to arrive saleable.`,
    aHtml: `<p>Yes — climate-controlled storage is usually worth it in Arkansas because the weather can shift from 100°F-plus humid summers to sub-freezing winter cold fronts in the same year. Arkansas summer humidity routinely exceeds 70%, heat indexes top 100°F, and home garages can hit <strong>120°F+ in direct sun</strong> — well above the safe storage range for furniture, electronics, photos, and instruments.</p><p>Climate-controlled storage at Modern Storage® gives those items an indoor environment that stays in a stable 59°F to 79°F range year-round. If you'd hesitate to leave it in a hot garage, climate-controlled is the safer choice.</p><p><strong>Climate-controlled is worth it in Arkansas if you are storing:</strong></p><ul><li>Wood furniture, leather furniture, or mattresses — warp, crack, and mildew in humid air</li><li>Electronics, TVs, computers, or media equipment — heat degrades capacitors and screens</li><li>Family photos, documents, books, or art — paper yellows and curls above ~70% humidity</li><li>Musical instruments, vinyl records, or wine — warp, mildew, or spoil in heat</li><li>Items stored for more than three months — cumulative damage builds in unconditioned spaces</li><li>Business inventory, samples, or records that need to arrive saleable</li></ul>`,
  },
  {
    // Phase 1 — upgraded with side-by-side bullet decision lists.
    // Direct competitor gap: most operators give a vague "it
    // depends" answer here. A clear decision framework wins both
    // PAA and AI-Overview extraction.
    q: 'Do I need climate-controlled storage or will drive-up be fine?',
    a: `Climate-controlled is the right call for furniture, electronics, photos, instruments, wine, vinyl, art, mattresses, and long-term storage of household items. Standard drive-up storage is usually fine for tools, lawn equipment, patio furniture, plastic bins, and durable items you'll access often. If you're storing a mix, climate-controlled covers everything. If the items already live happily in a hot garage, drive-up is the more affordable option. Choose climate-controlled for: wood and leather furniture, antiques; electronics, TVs, computers, gaming systems; mattresses, bedding, upholstered furniture; family photos, documents, books, art; musical instruments, vinyl records, wine, collectibles; clothing (wool, leather, silk, seasonal wardrobes); anything sentimental, valuable, or stored long-term. Standard drive-up storage is fine for: garden tools, lawn equipment, outdoor gear; patio furniture and grills; garage and basement overflow; plastic storage bins and totes; durable sports equipment; short-term storage during a quick move; items that already live in a hot garage.`,
    aHtml: `<p>Climate-controlled is the right call for furniture, electronics, photos, instruments, wine, vinyl, art, mattresses, and long-term storage of household items. Standard drive-up storage is usually fine for tools, lawn equipment, patio furniture, plastic bins, and durable items you'll access often. If you're storing a mix, climate-controlled covers everything. If the items already live happily in a hot garage, drive-up is the more affordable option.</p><p><strong>Choose climate-controlled for:</strong></p><ul><li>Wood and leather furniture, antiques</li><li>Electronics, TVs, computers, gaming systems</li><li>Mattresses, bedding, upholstered furniture</li><li>Family photos, documents, books, art</li><li>Musical instruments, vinyl records, wine, collectibles</li><li>Clothing (wool, leather, silk, seasonal wardrobes)</li><li>Anything sentimental, valuable, or stored long-term</li></ul><p><strong>Standard drive-up storage is fine for:</strong></p><ul><li>Garden tools, lawn equipment, outdoor gear</li><li>Patio furniture and grills</li><li>Garage and basement overflow</li><li>Plastic storage bins and totes</li><li>Durable sports equipment</li><li>Short-term storage during a quick move</li><li>Items that already live in a hot garage</li></ul>`,
  },
  {
    // Net-new Phase 1 — direct humidity-threshold target. Block 2
    // in the SEO plan called for explicit humidity damage Q&As to
    // own the "what humidity level damages X" PAA cluster.
    q: 'What humidity level damages stored items?',
    a: `Sustained humidity above 60% creates conditions where mold, mildew, warping, and corrosion can start damaging stored items. The danger zone for most household belongings starts around 65-70% relative humidity and gets worse the longer the exposure. Arkansas summer humidity routinely runs 70-90% outside, and inside an unconditioned garage, attic, or basement, humidity can climb even higher when warm humid air condenses on cool surfaces. Climate-controlled storage at Modern Storage® reduces indoor humidity through enclosed conditioned space, breaking the cycle that causes damage. Humidity damage thresholds for stored items: above 60% — mold and mildew can begin growing on paper, fabric, leather, and wood over time; above 70% — wood warps, photos curl and stick, books cup, metal develops light rust; above 80% — electronics develop condensation damage, mattresses absorb moisture and grow mold internally, leather cracks; outdoor Arkansas summer — humidity routinely 70-90% during the day, often higher inside unconditioned spaces; climate-controlled storage — enclosed indoor space stays drier and more stable than any non-conditioned alternative.`,
    aHtml: `<p>Sustained humidity above <strong>60%</strong> creates conditions where mold, mildew, warping, and corrosion can start damaging stored items. The danger zone for most household belongings starts around 65-70% relative humidity and gets worse the longer the exposure.</p><p>Arkansas summer humidity routinely runs 70-90% outside, and inside an unconditioned garage, attic, or basement, humidity can climb even higher when warm humid air condenses on cool surfaces. <a href="/climate-controlled">Climate-controlled storage at Modern Storage®</a> reduces indoor humidity through enclosed conditioned space, breaking the cycle that causes damage.</p><p><strong>Humidity damage thresholds for stored items:</strong></p><ul><li><strong>Above 60%</strong> — mold and mildew can begin growing on paper, fabric, leather, and wood over time</li><li><strong>Above 70%</strong> — wood warps, photos curl and stick, books cup, metal develops light rust</li><li><strong>Above 80%</strong> — electronics develop condensation damage, mattresses absorb moisture and grow mold internally, leather cracks</li><li><strong>Outdoor Arkansas summer</strong> — humidity routinely 70-90% during the day, often higher inside unconditioned spaces</li><li><strong>Climate-controlled storage</strong> — enclosed indoor space stays drier and more stable than any non-conditioned alternative</li></ul>`,
  },
  {
    // Net-new Phase 1 — direct Arkansas-summer-humidity Q&A. The
    // regional differentiator no national brand can write
    // authentically.
    q: 'Does climate-controlled storage prevent damage from Arkansas summer humidity?',
    a: `Yes — climate-controlled storage is specifically designed to reduce humidity exposure on stored items, which is the main threat to belongings during an Arkansas summer. Outside humidity in central and Northwest Arkansas regularly exceeds 70% from May through September, and unconditioned spaces like garages, attics, and outdoor storage units can reach even higher internal humidity when warm humid air condenses inside. A climate-controlled unit at Modern Storage® sits inside an enclosed, insulated, HVAC-managed building, so the indoor environment stays at roughly 59°F to 79°F year-round with substantially reduced humidity exposure. The result: less mildew on fabric, less warping on wood, less corrosion on metal, less paper damage, and fewer odors. How climate-controlled storage handles Arkansas summer: enclosed, insulated building keeps outdoor humidity from reaching stored items; HVAC system manages indoor temperature in the 59-79°F range; reduced humidity exposure helps prevent mold, mildew, and warping; protects furniture, electronics, photos, books, instruments, and mattresses through the worst summer months; indoor access from interior hallways — you don't have to move belongings through humid outside air to reach them; available at every Modern Storage® location across Arkansas.`,
    aHtml: `<p>Yes — climate-controlled storage is specifically designed to reduce humidity exposure on stored items, which is the main threat to belongings during an Arkansas summer. Outside humidity in central and Northwest Arkansas regularly exceeds 70% from May through September, and unconditioned spaces like garages, attics, and outdoor storage units can reach even higher internal humidity when warm humid air condenses inside.</p><p>A climate-controlled unit at Modern Storage® sits inside an enclosed, insulated, HVAC-managed building, so the indoor environment stays at roughly 59°F to 79°F year-round with substantially reduced humidity exposure. The result: less mildew on fabric, less warping on wood, less corrosion on metal, less paper damage, and fewer odors. See <a href="/climate-controlled-arkansas-humidity">why climate-controlled storage matters in Arkansas humidity</a>.</p><p><strong>How climate-controlled storage handles Arkansas summer:</strong></p><ul><li>Enclosed, insulated building keeps outdoor humidity from reaching stored items</li><li>HVAC system manages indoor temperature in the <strong>59-79°F</strong> range</li><li>Reduced humidity exposure helps prevent mold, mildew, and warping</li><li>Protects furniture, electronics, photos, books, instruments, and mattresses through the worst summer months</li><li>Indoor access from interior hallways — you don't have to move belongings through humid outside air to reach them</li><li>Available at every <a href="/locations">Modern Storage® location across Arkansas</a></li></ul>`,
  },
  {
