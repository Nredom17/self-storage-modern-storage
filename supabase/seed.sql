...
values
  (
    ...
    'Little Rock', 'AR', '[ZIP]', 'Little Rock Area',
    '[Street address placeholder]', '[CENTRALIZED PHONE NUMBER]',
    34.748, -92.376,
  ...
  (
    ...
    '3400 S Shackleford Rd', '[CENTRALIZED PHONE NUMBER]',
    34.7466, -92.4007,
  ...
  (
    ...
    '2510 Cantrell Rd', '[CENTRALIZED PHONE NUMBER]',
    34.7506, -92.2796,
    ...
    array['Climate-Controlled','Business Storage','Ground-Floor Access'],
  ...
  (
    ...
    'North Little Rock', 'AR', '[ZIP]', 'North Little Rock',
    '[Street address placeholder]', '[CENTRALIZED PHONE NUMBER]',
    34.769, -92.267,
    ...
    array['Climate-Controlled','Drive-Up Access','Business Storage'],
  ...
  (
    ...
    'Maumelle', 'AR', '[ZIP]', 'Maumelle',
    '[Street address placeholder]', '[CENTRALIZED PHONE NUMBER]',
    34.866, -92.404,
    '/images/modern-storage-maumelle-facility-aerial.jpg',
    'Modern Storage® Maumelle self-storage facility aerial view in Arkansas',
  ...
  (
    ...
    array['Climate-Controlled','Drive-Up Access','Boat/RV Storage'],
  ...
  (
    ...
    'Hot Springs', 'AR', '[ZIP]', 'Hot Springs',
    '[Street address placeholder]', '[CENTRALIZED PHONE NUMBER]',
    34.504, -93.055,
  ...
  (
    ...
    'Bentonville', 'AR', '[ZIP]', 'Northwest Arkansas',
    '[Street address placeholder]', '[CENTRALIZED PHONE NUMBER]',
    36.372, -94.208,
  ...
  (
    ...
    'Springdale', 'AR', '[ZIP]', 'Northwest Arkansas',
    '[Street address placeholder]', '[CENTRALIZED PHONE NUMBER]',
    36.187, -94.129,
  ...
  (
    ...
    '1407 W Monroe Ave', '[CENTRALIZED PHONE NUMBER]',
    36.255, -94.140,
    ...
    array['Climate-Controlled','Boat/RV Storage','Business Storage'],
